...
import { APP_NAME, debugLog, getProportionalFontSize } from '../utils/EDConstants'

export const showCustomAlert = (title = "", message = "", arrayButtonsToShow, iconName) => {
                        ...
                        <EDRTLView style={styles.titleViewStyle}>
                            <Text style={styles.titleTextStyle}>
                                {this.props.alertData.title !== undefined &&
                                    ...
                                    this.props.alertData.title : APP_NAME
                                }</Text>
                        </EDRTLView>
