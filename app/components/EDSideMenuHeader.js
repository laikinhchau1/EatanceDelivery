                ...
                <View style={styles.mainContainer}>
                    ...
                    <View style={[styles.bgImage, { justifyContent: 'center' }]}>
                        <TouchableOpacity style={styles.touchableContainer} onPress={this.props.onProfilePressed}>
                            <View style={{ alignItems: isRTLCheck() ? 'flex-end' : 'flex-start' }}>
                                ...
                                <View style={styles.profileDetailsContainer}>
                                    ...
                                    {this.props.userDetails.PhoneNumber
                                        ? <EDRTLText
                                            style={styles.email}
                                            title={this.props.userDetails.phone_code.includes('+') ? this.props.userDetails.phone_code : "+" + this.props.userDetails.phone_code + " " + this.props.userDetails.PhoneNumber} />
                                        : null}
                                    ...
                                    <EDRTLView style={{ alignItems: 'center',marginTop: 5, }}>
                                        ...
                                        {this.props.userDetails !== undefined && this.props.userDetails.FirstName !== undefined && this.props.userDetails.FirstName.trim() !== ''
                                            ...
                                            name={isRTLCheck() ? 'caretleft' : 'caretright'} size={10} color={EDColors.text} type={'ant-design'} /> : null} 
                                    </EDRTLView>
...
const styles = StyleSheet.create({
    ...
    profileDetailsContainer: { marginHorizontal: 5, justifyContent: 'center', paddingTop: 15 },
    fullName: { fontFamily: EDFonts.semibold, color: EDColors.black, fontSize: getProportionalFontSize(20) },
    email: { fontSize: getProportionalFontSize(14), color: EDColors.text, fontFamily: EDFonts.medium, marginTop: 5 },
    sidebarTextStyle: {  fontSize: getProportionalFontSize(14), fontFamily: EDFonts.semiBold, color: EDColors.blackSecondary },
