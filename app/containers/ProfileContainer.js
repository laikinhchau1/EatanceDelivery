...
import { getUserLoginDetails, saveUserLoginDetails } from '../utils/AsyncStorageHelper';
 ...
 */
   ...
   */
    buttonSavePressed = () => {
        if (this.validationsHelper.checkForEmpty(this.state.objProfileDetails.FirstName, strings('emptyFirstName')).length > 0) {
            showTopDialogue(strings('emptyFirstName'), true)
            return
        }

        else if (this.validationsHelper.checkForEmpty(this.state.objProfileDetails.LastName, strings('emptyLastName')).length > 0) {
        ...
        return (
            ...
            >
                ...
                <KeyboardAwareScrollView
                    ...
                    <View pointerEvents={this.state.isLoading ? "none" : "auto"} style={{ marginTop: 10 }}>
                        {/* PROFILE IMAGE COMPONENT */}
                        <EDProfilePicture imagePath={this.props.userDetails.image} onImageSelectionHandler={this.onImageSelectionHandler} />
                        ...
                        <View style={styles.textInputsContainer}>
                            ...
                            <EDRTLTextInput
                                ...
                                placeholderTextStyle={{ fontFamily: EDFonts.semiBold, fontSize: getProportionalFontSize(16) }} //Vikrant 19-07-21
                            ...
                            <EDRTLTextInput
                                ...
                                countryData={this.props.countryData}
                                dialCode={this.state.objProfileDetails.phone_code.includes('+') ? this.state.objProfileDetails.phone_code.substring(1) : this.state.objProfileDetails.phone_code}
                                icon="call"
                                editableBox={false}
                                initialValue={this.state.objProfileDetails.PhoneNumber}
                                placeholderTextStyle={{ fontFamily: EDFonts.bold, fontSize: getProportionalFontSize(16) }} //Vikrant 19-07-21
                            ...
                            {/* TEMPARETURE */}
                            {this.state.objProfileDetails.driver_temperature !== undefined && this.state.objProfileDetails.driver_temperature !== null &&
...
const styles = StyleSheet.create({
    imageStyle: {
        alignSelf: 'center',
        height: Metrics.screenHeight * .45,
